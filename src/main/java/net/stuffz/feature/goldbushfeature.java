...
// ChunkGenerator<? extends ChunkGeneratorConfig> generator, Random random,
// BlockPos pos,
// DefaultFeatureConfig config) {
// BlockPos bush1 = new BlockPos(pos.getX(), pos.getY(), pos.getZ());
// BlockPos bush2 = new BlockPos(bush1.getX() + 1, bush1.getY(), bush1.getZ() +
// 2);
...
// && world.getBlockState(bush2.north()).isAir() &&
// world.getBlockState(bush1.up()).isAir()
...
// @Override
// public boolean generate(ServerWorldAccess serverWorldAccess,
// StructureAccessor accessor, ChunkGenerator generator,
// Random random, BlockPos pos, DefaultFeatureConfig config) {
