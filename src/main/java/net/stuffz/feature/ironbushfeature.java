...
public class ironbushfeature extends Feature<DefaultFeatureConfig> {
  ...
  public ironbushfeature(Function<Dynamic<?>, ? extends DefaultFeatureConfig> config) {
    super(config);
  }
  ...
  public boolean generate(IWorld world, ChunkGenerator<? extends ChunkGeneratorConfig> chunkGenerator, Random random,
    ...
    if (world.getBlockState(bush1).isAir() && world.getBlockState(bush2).isAir()
      ...
      world.setBlockState(bush1, main.IRONBUSH.getDefaultState(), 3);
      world.setBlockState(bush2, main.IRONBUSH.getDefaultState(), 3);
      return true;
    } else {
      return false;
    }
