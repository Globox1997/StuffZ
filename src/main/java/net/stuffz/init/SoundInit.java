...
public class SoundInit {
  ...
  public static BlockSoundGroup IRONLADDER_GROUP = new BlockSoundGroup(1F, 1F, SoundEvents.BLOCK_METAL_BREAK,
      IRONLADDER_EVENT, SoundEvents.BLOCK_METAL_PLACE, SoundEvents.BLOCK_METAL_HIT, SoundEvents.BLOCK_METAL_FALL);
