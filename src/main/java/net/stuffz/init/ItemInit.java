...
public class ItemInit {
    ...
    public static final IronHammer IRONHAMMER = new IronHammer(1F, -2.8F, ToolMaterials.IRON, BlockTags.ANVIL, new Item.Settings().group(ItemGroup.TOOLS).maxDamage(461));
