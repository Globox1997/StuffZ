...
public class BlockInit {
    ...
    public static void init() {
        ...
        Registry.register(Registry.ITEM, new Identifier("stuffz", "nutsbush"),
                new BlockItem(NUTSBUSH, new Item.Settings().group(ItemGroup.MISC).food(FoodComponents.SWEET_BERRIES)));
        ...
        Registry.register(Registry.ITEM, new Identifier("stuffz", "speltwheat"), ItemInit.SPELTWHEAT);
        ...
        Registry.register(Registry.ITEM, new Identifier("stuffz", "darkmalt"), ItemInit.DARKMALT);
