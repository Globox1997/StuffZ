...
public class UncraftBlockRenderer implements BlockEntityRenderer<UncraftBlockEntity> {
    ...
    public UncraftBlockRenderer(BlockEntityRendererFactory.Context ctx) {
    }

    @Override
    public void render(UncraftBlockEntity blockEntity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
